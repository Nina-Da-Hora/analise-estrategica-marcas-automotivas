...
O projeto foi desenvolvido utilizando ferramentas amplamente usadas em projetos de Data Analytics:

* Python – processamento e análise de dados

* Pandas – manipulação e limpeza dos dados

* SQL (SQLite) – consultas analíticas e cálculo de métricas

* SQLAlchemy – criação e gerenciamento do banco de dados
